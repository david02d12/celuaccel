...
interface ApiService {
    ...
    // MENSAJES
    // ==========================================
    @GET("mensajes/por-chat/{codigoChat}")
    fun getMensajesPorChat(@Header("Authorization") token: String, @Path("codigoChat") codigoChat: Int): Call<List<Mensaje>>

    @POST("mensajes/agregar")
    fun enviarMensaje(@Header("Authorization") token: String, @Body mensaje: Mensaje): Call<Void>

    @DELETE("mensajes/eliminar/{id}")
    fun eliminarMensaje(@Header("Authorization") token: String, @Path("id") id: Int): Call<Void>
    ...
    @PUT("comentarios/actualizar")
    fun actualizarComentario(
        @Header("Authorization") token: String,
        @Body comentario: Comentario
    ): Call<Void>
    ...
    /** Eliminar notificación (Admin/Técnico) */
    ...
    /** Listar tipos de documento (autenticado) */
    @GET("tipodocumento/listar")
    fun getTiposDocumento(@Header("Authorization") token: String): Call<List<TipoDocumento>>

    /** Agregar tipo de documento (solo admin) */
    @POST("tipodocumento/agregar")
    fun agregarTipoDocumento(
        @Header("Authorization") token: String,
        @Body tipo: TipoDocumento
    ): Call<Void>

    /** Actualizar tipo de documento (solo admin) */
    @PUT("tipodocumento/actualizar")
    fun actualizarTipoDocumento(
        @Header("Authorization") token: String,
        @Body tipo: TipoDocumento
    ): Call<Void>

    /** Eliminar tipo de documento (solo admin) */
    @DELETE("tipodocumento/eliminar/{id}")
