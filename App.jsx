...
//  Importa los nuevos componentes de recuperación
...
function App() {
  ...
  //  Si no está logueado, mostrar login, registro o recuperación
  if (!logueado) {
    if (modoRegistro) {
      return <Registro setModoRegistro={setModoRegistro} />;
    }
